...
Then just run the whole .ipynb and you will be able to observe our results.
(You will need to introduce some inputs in a couple of examples, but it will be clearly indicated).
